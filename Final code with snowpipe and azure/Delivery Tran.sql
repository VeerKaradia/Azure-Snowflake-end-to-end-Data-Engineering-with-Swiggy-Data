...
USING (
    SELECT 
        ...
        TO_VARCHAR(TRY_TO_TIMESTAMP_NTZ(createddate), 'YYYY-MM-DD HH24:MI:SS.FF6') AS created_date,
        TO_VARCHAR(TRY_TO_TIMESTAMP_NTZ(modifieddate), 'YYYY-MM-DD HH24:MI:SS.FF6') AS modified_date,
        _stg_file_name,
        _stg_file_load_ts,
        _stg_file_md5,
        _copy_data_ts
